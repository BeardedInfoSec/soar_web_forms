...
/** @public */
type NumberFocusHandler = (event: React.FocusEvent<HTMLInputElement | HTMLTextAreaElement>, data: {
    name?: string;
    value: string;
}) => void;
...
declare const defaultProps: Required<Pick<NumberPropsBase, 'append' | 'disabled' | 'error' | 'hideStepButtons' | 'inline' | 'locale' | 'placeholder' | 'prepend' | 'roundTo' | 'step'>>;
interface NumberPropsBaseControlled extends NumberPropsBase {
    defaultValue?: never;
    onChange: NumberChangeHandler;
    value?: number;
}
interface NumberPropsBaseUncontrolled extends NumberPropsBase {
    defaultValue?: number;
    value?: never;
}
type NumberInputProps = ClassComponentProps<NumberPropsBaseControlled | NumberPropsBaseUncontrolled, typeof defaultProps, 'div'>;
interface NumberInputState {
    stringValue: string;
    prevValueProp?: number;
    value?: number;
}
...
export type { NumberInput as NumberWithoutTheme };
