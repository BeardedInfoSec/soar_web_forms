...
interface ColorPropsBase {
    ...
    palette?: (string | null)[];
    /** This has no effect on the appearance at this time but is recommended to be used when a
...
interface ColorPropsBaseUncontrolled extends ColorPropsBase {
    defaultValue?: string | null;
    value?: never;
}
type ColorProps = ClassComponentProps<ColorPropsBaseControlled | ColorPropsBaseUncontrolled, typeof defaultProps, 'button'>;
...
declare const isValidHEX: (value: string) => boolean;
declare class Color extends Component<ColorProps, ColorState> {
    private focusSwatch;
    ...
    private handlePaletteExpand;
    private handleTextChange;
    private handleTextKeyDown;
    private handleButtonClick;
    private handleRequestClose;
    private handleRequestOpen;
    private handleSystemColorPickerChange;
    private submitValue;
    /**
