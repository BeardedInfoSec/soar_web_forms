...
interface TransitionOpenPropsBase {
    ...
    /**
     * When true, children are always rendered whether open or closed.
     */
...
declare class TransitionOpen extends Component<TransitionOpenProps, TransitionOpenState> {
    ...
    static getDerivedStateFromProps(nextProps: Readonly<TransitionOpenProps>, prevState: TransitionOpenState): Partial<TransitionOpenState> | null;
