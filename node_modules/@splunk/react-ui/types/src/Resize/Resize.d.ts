...
/** @public */
type ResizeRequestResizeHandler = (event: MouseEvent | React.KeyboardEvent<HTMLButtonElement>, data: {
    height: number;
    width: number;
}) => void;
...
type ResizeProps = ClassComponentProps<ResizePropsBase, typeof defaultProps, 'div'>;
