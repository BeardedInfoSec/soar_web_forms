...
/** @public */
type SidePanelRequestCloseHandler = (data: {
...
type SidePanelProps = ClassComponentProps<SidePanelPropsBase, typeof defaultProps, 'div'>;
interface SidePanelState {
    panelAnimating: boolean;
    prevOpen: boolean;
}
declare class SidePanel extends Component<SidePanelProps, SidePanelState> {
    static propTypes: React.WeakValidationMap<SidePanelProps>;
    static defaultProps: Required<Pick<SidePanelPropsBase, "open" | "dockPosition" | "useLayerForClickAway">>;
    static getDerivedStateFromProps(nextProps: Readonly<SidePanelProps>, prevState: SidePanelState): Partial<SidePanelState> | null;
