...
interface OptionPropsBase {
    ...
    /**
     * @deprecated Icon is deprecated and will be removed in a the next major version. Use `startAdornment` and/or `endAdornment` instead.
     *
