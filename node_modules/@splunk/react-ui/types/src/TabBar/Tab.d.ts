...
type TabClickHandler = (event: React.MouseEvent<HTMLButtonElement>, data: {
    tabId?: string;
    tabKey?: number;
}) => void;
type TabFocusHandler = (event: React.FocusEvent<HTMLButtonElement>, data: {
    tabId?: string;
    tabKey?: number;
}) => void;
...
type TabProps = ClassComponentProps<TabPropsBase, typeof defaultProps, 'div'>;
interface TabState {
...
declare class Tab extends Component<TabProps, TabState> {
    ...
    static propTypes: React.WeakValidationMap<TabProps>;
