...
interface ItemPropsBase {
    ...
    /**
     * If selected is true, a checkmark shows the item is selected.
     */
    selected?: boolean;
    /** @private */
...
declare class Item extends Component<ItemProps, {}> {
    ...
    static defaultProps: Required<Pick<ItemPropsBase, "selected" | "active" | "openInNewContext" | "descriptionPosition" | "hasSubmenu" | "preventFocus" | "selectable" | "selectableAppearance" | "truncate">>;
    static as: string;
