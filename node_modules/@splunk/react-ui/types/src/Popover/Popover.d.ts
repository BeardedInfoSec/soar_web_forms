...
/** @public */
type PopoverPlacementStatus = 'above' | 'below' | 'left' | 'right' | 'misaligned';
/** @public */
type PopoverPossibleCloseReason = 'clickAway' | 'escapeKey' | 'offScreen' | 'tabKey';
/** @public */
type PopoverRequestCloseHandler = (data: {
...
interface PopoverPropsBase {
    ...
    animation?: boolean;
    /**
     * Allows the animation config to be overridden.
     * This is merged with Popover's default animation config.
     * @private
     */
    ...
    open?: boolean;
    /**
     * A ref for the outer popover container.
     * @private
     */
...
declare const defaultProps: Required<Pick<PopoverPropsBase, 'align' | 'animation' | 'animationConfig' | 'appearance' | 'autoCloseWhenOffScreen' | 'canCoverAnchor' | 'closeReasons' | 'defaultPlacement' | 'open' | 'repositionMode' | 'retainFocus' | 'takeFocus'>>;
type PopoverProps = ClassComponentProps<PopoverPropsBase, typeof defaultProps, 'div'>;
