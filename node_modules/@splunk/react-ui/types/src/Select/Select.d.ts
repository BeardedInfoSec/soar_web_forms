...
/** @public */
type SelectFilterChangeHandler = (event: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement> | React.MouseEvent<HTMLSpanElement> | React.KeyboardEvent, data: {
    keyword: string;
}) => void;
/** @public */
...
interface SelectPropsBase {
     ...
     * Keymatching is disabled when using filtering or loading.
     */
     ...
     * criteria.
     */
    onFilterChange?: SelectFilterChangeHandler;
    /**
     ...
     */
    onScrollBottom?: SelectScrollBottomHandler;
    /**
...
declare const defaultProps: Required<Pick<SelectPropsBase, 'allowKeyMatching' | 'animateLoading' | 'appearance' | 'append' | 'children' | 'defaultPlacement' | 'disabled' | 'error' | 'filter' | 'inline' | 'isLoadingOptions' | 'menuStyle' | 'noOptionsMessage' | 'placeholder' | 'prepend' | 'toggleContent'>>;
interface SelectPropsBaseControlled extends SelectPropsBase {
    defaultValue?: never;
    onChange: SelectChangeHandler;
    value?: string | number | boolean;
}
interface SelectPropsBaseUncontrolled extends SelectPropsBase {
    defaultValue?: string | number | boolean;
    value?: never;
}
type SelectProps = ClassComponentProps<SelectPropsBaseControlled | SelectPropsBaseUncontrolled, typeof defaultProps, 'button'>;
