/******/ (() => {
    ...
    /******/    (() => {
        /******/ L.o = (L, e) => Object.prototype.hasOwnProperty.call(L, e)
        /******/;
    })();
    /******/
    ...
    var a =  L.n(n);
    // CONCATENATED MODULE: ./src/enterprise/GearUnfilled.tsx
    function o() {
        return o = Object.assign ? Object.assign.bind() : function(L) {
            for (var e = 1; e < arguments.length; e++) {
                var C = arguments[e];
                for (var r in C) {
                    ({}).hasOwnProperty.call(C, r) && (L[r] = C[r]);
                }
            }
            return L;
    ...
    function l(L) {
        ...
        return r().createElement(a(), o({
            screenReaderText: (0, t._)("Gear Unfilled"),
            viewBox: "0 0 20 20"
        }, L),  r().createElement("g", null,  r().createElement("path", {
