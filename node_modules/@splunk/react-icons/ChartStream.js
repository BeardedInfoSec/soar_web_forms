/******/ (() => {
    ...
    // CONCATENATED MODULE: ./src/icons/ChartStream.tsx
    function o(e, r) {
        if (null == e) return {};
        var t, C, n = u(e, r);
    ...
    c.set("filled", (function() {
        ...
        return C().createElement(C().Fragment, null,  C().createElement("path", {
            ...
            d: "M21 8C19.5399 8 18.6904 7.42265 18.0067 6.95795C17.9433 6.91483 17.8812 6.87268 17.8203 6.83205C17.1782 6.40396 16.4942 6 15 6C13.4621 6 12.2792 6.91084 10.6506 8.16493L10.4847 8.29262C8.85611 9.54539 6.8675 11 4 11H3V13H5C7.14939 13 8.54761 12.057 9.94619 10.9625C10.0739 10.8625 10.2039 10.7589 10.3364 10.6532C11.5753 9.66506 13.036 8.5 15 8.5C16.0011 8.5 16.7964 8.68025 17.4661 8.97571C18.1278 9.26762 18.6202 9.65266 19.0152 9.98178C19.0722 10.0293 19.1269 10.0752 19.1797 10.1194C19.8742 10.7016 20.2302 11 21 11V8Z"
        }),  C().createElement("path", {
            d: "M21 13C19.4748 13 18.5912 12.2469 17.922 11.6766C17.8578 11.6219 17.7954 11.5687 17.7348 11.5182C17.3798 11.2223 17.0597 10.9824 16.6589 10.8055C16.2661 10.6322 15.7489 10.5 15 10.5C13.7695 10.5 12.8691 11.2083 11.5049 12.2814C11.3993 12.3645 11.2904 12.4502 11.1788 12.5375C9.70239 13.693 7.85061 15 5 15H3V17H6C7.66249 17 9.0614 16.1739 10.4914 15.1791C10.6439 15.0731 10.799 14.9634 10.956 14.8525C11.498 14.4694 12.0608 14.0717 12.6009 13.7593C13.3046 13.3524 14.1136 13 15 13C16.0899 13 16.9286 13.3194 17.5982 13.8296C18.2327 14.313 18.6715 14.9389 19.0115 15.4335C19.7537 16.513 20.1 17 21 17V13Z"
        }),  C().createElement("path", {
    ...
    /**
 * @description Charts Stream represents a type of visualization
 * @category Data Visualization
 * @keywords chart, dashboard studio, data visualization editor
 * @variants outlined,filled
 */    var v = function e(r) {
        var n = r.children, u = r.variant, i = u === void 0 ? "default" : u, d = o(r, [ "children", "variant" ]);
        var v = f(i);
        ...
        return C().createElement(a(), d, n, p ?  C().createElement("use", {
            href: "#".concat(s)
        }) : !!m && m());
    };
