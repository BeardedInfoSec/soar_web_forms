...
/**
 * @description Laptop PC device
 * @category Objects
 * @keywords laptop, pc, device, mobile, client
 * @variants outlined,filled
 */
declare const LaptopOpen: ({ children, variant, ...otherprops }: IconBaseProps) => JSX.Element | null;
