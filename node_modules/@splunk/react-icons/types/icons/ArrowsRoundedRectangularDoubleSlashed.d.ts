 ...
 * @variants outlined
 */
declare const ArrowsRoundedRectangularDoubleSlashed: ({ children, variant, ...otherprops }: IconBaseProps) => JSX.Element | null;
export default ArrowsRoundedRectangularDoubleSlashed;
