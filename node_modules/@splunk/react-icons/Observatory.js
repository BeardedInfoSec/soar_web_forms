/******/ (() => {
    ...
    // CONCATENATED MODULE: ./src/icons/Observatory.tsx
    function u(e, r) {
        if (e == null) return {};
        var t = i(e, r);
        var n, o;
    ...
    /**
 * @description Observability application and destination, Objects, telemetry, telescope, building, astronomy
 *
 *
 ...
 */    var v = function e(r) {
        ...
        var v = f(C);
        var s = "observatory-".concat(v);
        var V = (0, t.useContext)(a.IconContext);
        var p = c.get(v);
        if (false) {}
        if (V && p) {
            var L = V.toRender, H = V.addIcon;
            H(s, p());
            if (!L) {
                return null;
            }
        ...
        return n().createElement(l(), d, o, V ?  n().createElement("use", {
            href: "#".concat(s)
        }) : !!p && p());
    };
