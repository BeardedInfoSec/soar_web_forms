/******/ (() => {
    ...
    // CONCATENATED MODULE: ./src/icons/TextAa.tsx
    function u(e, r) {
        if (e == null) return {};
        var t = C(e, r);
        var n, o;
    ...
    /**
 * @description Text Strings represents a type of field data format
 * @category Data Type
 * @keywords text, letter, alphabet, strings, Aa
 * @variants outlined
 */    var v = function e(r) {
        var o = r.children, C = r.variant, c = C === void 0 ? "default" : C, d = u(r, [ "children", "variant" ]);
        var v = f(c);
        var s = "textaa-".concat(v);
