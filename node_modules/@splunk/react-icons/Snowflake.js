    ...
    function l(e, r) {
        ...
        if (Object.getOwnPropertySymbols) {
            ...
            for (t = 0; t < C.length; t++) {
                L = C[t], r.includes(L) || {}.propertyIsEnumerable.call(e, L) && (n[L] = e[L]);
            }
        }
        return n;
    }
 ...
 */    var f = function e(r) {
        var n = r.children, o = r.variant, i = o === void 0 ? "default" : o, c = l(r, [ "children", "variant" ]);
        var f = d(i);
        var v = "snowflake-".concat(f);
        var s = (0, L.useContext)(a.IconContext);
        var p = u.get(f);
        if (false) {}
        if (s && p) {
