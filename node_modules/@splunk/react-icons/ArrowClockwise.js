/******/ (() => {
    ...
    // CONCATENATED MODULE: ./src/icons/ArrowClockwise.tsx
    function l(e, r) {
        if (null == e) return {};
        var t, n, a = i(e, r);
    ...
    /**
 * @description Rotate Clockwise action for rotating an object 90 degrees clockwise in editing
 * @category Controls
 * @keywords refresh, loop, repeat, cycle
 * @variants outlined
 */    var s = function e(r) {
        var a = r.children, i = r.variant, f = i === void 0 ? "default" : i, d = l(r, [ "children", "variant" ]);
        var s = v(f);
        var p = "arrowclockwise-".concat(s);
