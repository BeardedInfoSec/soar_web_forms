/******/ (() => {
    ...
    // CONCATENATED MODULE: ./src/icons/ArrowCircleOutRight.tsx
    function u(e, t) {
        if (e == null) return {};
        var r = i(e, t);
        var n, a;
    ...
    /**
 * @description Used as a source place where data comes from
 * @category Data Flow
 * @keywords data flow, departure, destination, arrow out, left to right
 * @variants outlined,filled
 */    var v = function e(t) {
        var a = t.children, i = t.variant, f = i === void 0 ? "default" : i, d = u(t, [ "children", "variant" ]);
        var v = C(f);
        var s = "arrowcircleoutright-".concat(v);
